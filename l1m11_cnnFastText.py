...
from keras.layers import Bidirectional, GlobalMaxPool1D, BatchNormalization, GlobalAveragePooling1D, PReLU, Conv1D
...
#        train, test = pk.load(f)
    ...
    x = Bidirectional(GRU(rnn_units, return_sequences=True, dropout=0.1, recurrent_dropout=0.1))(x)
